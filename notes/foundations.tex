...
conditions), \code{fft.tex} (the numerical Fourier transform), and
...
states the few facts we use; the companion note \code{fft.tex} develops
...
therefore be purely real; \code{fft.tex} \S\ref{sec:fourier} works
...
spectrum; \code{fft.tex} Appendix and \code{cosmo\_ic.tex} Appendix~A
...
grid estimator) is the better probe, as \code{CLAUDE.md} and the Corrfunc
notes discuss.
...
\begin{itemize}
  ...
  \item \textbf{The numerical Fourier transform} --- the discrete and
        ...
        algorithms: \code{fft.tex}.  Figure~\ref{fig:grf-exp} is borrowed
        from there.
