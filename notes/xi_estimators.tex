...
% Notation follows cosmo_stat.tex, which lives in the ai-notes repository
% (bold vectors, \avg, \hat\delta_\bk,
...
returns to the distinction, and \code{cosmo\_stat.pdf}, in the
\code{ai-notes} repository, treats it at length.
...
the distinction is the subject of \code{cosmo\_stat.pdf} in the
\code{ai-notes} repository
