...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrl}
    ...
    fit & $A$ & \\
    \midrule
    all subvolumes, window in the model & $0.9995 \pm 0.0765$ & unbiased \\
    all subvolumes, raw theory          & $0.892$             & the wrong model absorbs the deficit \\
    the subvolumes a search keeps, window in the model & $1.065$ & $0.85\sigma$ high \\
    \bottomrule
  \end{tabular}
\end{table}
