...
compute_xi_cic: src/compute_xi_cic.c
	$(CC) -O3 -std=c99 -Wall $(OMP_FLAG) -I$(HDF5_INC) -I$(FFTW_INC) \
	      -L$(HDF5_LIB) -L$(FFTW_LIB) -lhdf5 -lfftw3 -lm $(OMP_FLAG) \
	      $< -o $@
