...
def main():
    ...
    if args.fold:
        ...
        if redshift > 2:
            ...
            print(f"  Particle spacing d = {d_mpc:.3g} Mpc → k_lattice = {k_lattice_mpch:.3g} h/Mpc")
            print(f"  At high z, rms displacements << d, so folding aliases the lattice")
            print(f"  power into the measurement range. Use folding only at z ≲ 1–2.")
